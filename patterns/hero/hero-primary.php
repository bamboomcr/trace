 ...
 * Slug: trace/hero-primary-cta
 * Categories: trace-hero
 * Keywords: hero, banners, cover, cta, parallax
 * Viewport Width: 1400
 */
$img = get_theme_file_uri( 'assets/images/hero-default.png' );
?>

<!-- wp:cover {"metadata":{"name":"Hero — Primary Call to Action"},"url":"<?php echo esc_url( $img ); ?>","hasParallax":true,"dimRatio":60,"overlayColor":"background","isUserOverlayColor":true,"minHeight":90,"minHeightUnit":"vh","contentPosition":"bottom left","align":"full","style":{"spacing":{"padding":{"top":"var:preset|spacing|5xl","bottom":"var:preset|spacing|5xl","left":"var:preset|spacing|3xl","right":"var:preset|spacing|3xl"}}}} -->
...
<div class="wp-block-buttons"><!-- wp:button {"className":"is-style-outline","style":{"spacing":{"padding":{"top":"24px","right":"48px","bottom":"24px","left":"48px"}},"typography":{"fontSize":"16px","fontStyle":"normal","fontWeight":"600","letterSpacing":"0px"}}} -->
<div class="wp-block-button is-style-outline"><a class="wp-block-button__link has-custom-font-size wp-element-button" href="#build-fast" style="padding-top:24px;padding-right:48px;padding-bottom:24px;padding-left:48px;font-size:16px;font-style:normal;font-weight:600;letter-spacing:0px">Get started</a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons --></div></div>
<!-- /wp:cover -->